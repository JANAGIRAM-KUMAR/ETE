        ...
        {user && (
          <div className="hidden md:flex items-center gap-6">
            <button 
              ...
              className={`text-xs font-black uppercase tracking-widest hover:text-red-600 transition-colors ${transparent ? 'text-white/70' : 'text-slate-500'}`}
            >
              Dashboard
            </button>
          </div>
        ...
        {user ? (
          <>
            <div className="hidden sm:flex flex-col items-end mr-2 text-right">
              ...
              <span className={`text-[10px] font-black uppercase tracking-[0.1em] ${transparent ? 'text-white/60' : 'text-red-600'}`}>
          ...
          <Link
            to="/login"
            className="px-6 py-2.5 bg-red-600 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-red-700 shadow-lg shadow-red-500/20 transition-all duration-200"
          >
            Sign In
          </Link>
        )}
